void macro_PunchThroughCuts()
{
  std::string path_to_file ("data/UsefulHistograms_Merged_4040_4661.root");
  TFile * FileIn = new TFile(path_to_file.c_str());

  TFile * fileout = new TFile("data/UsefulHistograms_Merged_4040_4661_Cuts.root", "UPDATE");
