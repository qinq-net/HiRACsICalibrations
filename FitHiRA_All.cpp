...
void FitHiRA_All()
{
   ...
   ofstream FileOut[5];
   FileOut[0].open("FitResult/CompareWithWMU/FitParameters_proton.dat");
   FileOut[1].open("FitResult/CompareWithWMU/FitParameters_deuteron.dat");
   FileOut[2].open("FitResult/CompareWithWMU/FitParameters_triton.dat");
   FileOut[3].open("FitResult/CompareWithWMU/FitParameters_3He.dat");
   FileOut[4].open("FitResult/CompareWithWMU/FitParameters_4He.dat");

   FileOut[0] << setw(5) <<"*telnum" <<"  "<< setw(10) << "csinum" <<"  "<< setw(10) << "Par0" <<"  "<<setw(10)<<"errPar0"<<"  "<<setw(10)<<"Par1" <<"  "<<setw(10)<<"errPar1\n";
   ...
   Int_t NFiles_proton=9;
   std::string * FileIn_name_proton[NFiles_proton];
   FileIn_name_proton[0] = new std::string("calibrations/WMUdata_Z01_A01.dat");   // WMU data
  // FileIn_name_proton[1] = new std::string("calibrations/HiRA_CsI_DEELowEnergy_Z01_A01.dat"); //DEE points
  // FileIn_name_proton[1] = new std::string("calibrations/HiRA_CsI_DEEMidEnergy_Z01_A01.dat"); //DEE points
   FileIn_name_proton[1] = new std::string("calibrations/DEEPoints_Z01_A01.dat"); //DEE points
   ...
   FileIn_name_proton[4] = new std::string("calibrations/Corrected_HiRA_CsIKinimatics_4034_4037_48Ca28.0AMeV_gain 170.dat"); // kinematics ponits
   FileIn_name_proton[5] = new std::string("calibrations/Corrected_HiRA_CsIKinimatics_4332_4332_48Ca56.6AMeV_gain 170.dat"); // kinematics ponits
   FileIn_name_proton[6] = new std::string("calibrations/Corrected_HiRA_CsIKinimatics_4577_4584_48Ca28.0AMeV_gain 170.dat"); // kinematics ponits
   FileIn_name_proton[7] = new std::string("calibrations/Corrected_HiRA_CsIKinimatics_4585_4589_48Ca56.6AMeV_gain 170.dat"); // kinematics ponits
   FileIn_name_proton[8] = new std::string("calibrations/HiRA_CsI_PunchThrough_Z01_A01.dat");  // punch through points
...
//   FileIn_name_deuteron[1] = new std::string("calibrations/HiRA_CsI_DEELowEnergy_Z01_A02.dat"); //DEE points
//   FileIn_name_deuteron[1] = new std::string("calibrations/HiRA_CsI_DEEMidEnergy_Z01_A02.dat"); //DEE points
   FileIn_name_deuteron[1] = new std::string("calibrations/DEEPoints_Z01_A02.dat"); //DEE points
   ...
   //FileIn_name_triton[0] = new std::string("calibrations/HiRA_CsI_DEELowEnergy_Z01_A03.dat"); //DEE points
  // FileIn_name_triton[0] = new std::string("calibrations/HiRA_CsI_DEEMidEnergy_Z01_A03.dat"); //DEE points
   FileIn_name_triton[0] = new std::string("calibrations/DEEPoints_Z01_A03.dat"); //DEE points
...
//   FileIn_name_3He[0] = new std::string("calibrations/HiRA_CsI_DEELowEnergy_Z02_A03.dat"); //DEE points
   FileIn_name_3He[0] = new std::string("calibrations/DEEPoints_Z02_A03.dat"); //DEE points
//   FileIn_name_3He[1] = new std::string("calibrations/HiRA_CsI_DEEMidEnergy_Z02_A03.dat"); //DEE points
  ...
  //     if(err_Energy_3He[telnum][csinum][FileNum][NPoints_3He[telnum][csinum][FileNum]]==0) continue;
   ...
   FileIn_name_4He[0] = new std::string("calibrations/WMUdata_Z02_A04.dat");   // WMU data
  // FileIn_name_4He[1] = new std::string("calibrations/HiRA_CsI_DEELowEnergy_Z02_A04.dat"); //DEE points
//   FileIn_name_4He[1] = new std::string("calibrations/HiRA_CsI_DEEMidEnergy_Z02_A04.dat"); //DEE points
   FileIn_name_4He[1] = new std::string("calibrations/DEEPoints_Z02_A04.dat"); //DEE points
   ...
   for(int i=0; i<TELNUM; i++)
   {
     ...
     for(int j=0; j<CSINUM; j++)
     {
      ...
      Graph[i][j]->Draw("APE");
      Graph[i][j]->GetXaxis()->SetTitle("LISE Energy (MeV)");
      Graph[i][j]->GetXaxis()->CenterTitle(true);
      Graph[i][j]->GetXaxis()->SetTitleSize(0.05);
      Graph[i][j]->GetXaxis()->SetLabelSize(0.05);
      Graph[i][j]->GetYaxis()->SetTitle("CsIVoltage (V)");
      Graph[i][j]->GetYaxis()->CenterTitle(true);
      Graph[i][j]->GetYaxis()->SetTitleSize(0.05);
      Graph[i][j]->GetYaxis()->SetLabelSize(0.05);
    //  Graph[i][j]->GetXaxis()->SetRangeUser(0, 20);
    //  Graph[i][j]->GetYaxis()->SetRangeUser(0., 0.3);
      legend[i][j]->Draw("SAME");


      //----- fit for protons -------------------------------------------------------------
      TF1 * fit_proton=new TF1(Form("fit_proton%02d_%02d", i,j),"[0]*x^{[1]}",0, 320);
      fit_proton->SetParameters(0.003,0.9);
      ...
      double err_par0_proton = fit_proton->GetParError(0);
      double par1_proton = fit_proton->GetParameter(1);
      double err_par1_proton = fit_proton->GetParError(1);
      FileOut[0] << setw(5) << i <<"  "<< setw(10) << j <<"  "<< setw(10) << par0_proton <<"  "<<setw(10)<< err_par0_proton <<" "<<setw(10)<< par1_proton <<"  "<<setw(10) << err_par1_proton << endl;


      //----- fit for deuterons -------------------------------------------------------------
      TF1 * fit_deuteron=new TF1(Form("fit_deuteron%02d_%02d", i,j),"[0]*x^{[1]}",0, 320);
      fit_deuteron->SetParameters(0.003,0.9);
      graph_deuteron[i][j]->Fit(fit_deuteron,"RCW+");
      ...
      fit_triton->SetParameters(0.003,0.9);
      ...
      c1->Print(Form("FitResult/CompareWithWMU/Tel%02d_CsI%02d Calibraion.png", i, j));
