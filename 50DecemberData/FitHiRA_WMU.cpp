...
void FitHiRA_WMU()
{
   ...
   Int_t NFiles_proton=2;
   std::string * FileIn_name_proton[NFiles_proton];
   FileIn_name_proton[0] = new std::string("calibrations/HiRA_CsI_DEEPoints_Z01_A01.dat");
   FileIn_name_proton[1] = new std::string("calibrations/HiRA_KinematicPoints_CH2_1.2Tm_1H_12C_Z01_A01.dat");
/*  
...
*/       
   ...
   for(int i=0; i<TELNUM; i++)
   {
     for(int j=0; j<CSINUM; j++)
     {
      ...
      fit_proton->SetParameters(0.003,1.2);
