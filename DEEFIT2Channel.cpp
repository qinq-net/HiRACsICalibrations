...
void DEEFIT2Channel()
{
  ...
  double errPercentageSiE = 0.01;

  ifstream FileInCut("calibrations/DEEFITCut.dat");
  ifstream FileInPar("calibrations/DEEFITParameters.dat");

  ofstream FileOut("calibrations/DEEFITPointsChannelFinal.dat");
  FileOut << setw(5) <<" *tel " << setw(10) << "numcsi " << setw(5) << "Z" << setw(5) << "A" <<setw(10) << "CsIV " << setw(15) << "errCsIV" << setw(15) << "CsIE" << setw(15) << "errCsIE\n";

  ofstream FileOutDEE("calibrations/DEEChannel_ESi.dat");
  FileOutDEE << setw(5) <<" *tel " << setw(10) << "numcsi " << setw(5) << "Z" << setw(5) << "A" <<setw(10) << "CsIV" << setw(15) << "errCsIV" << setw(15) << "ESi" << setw(15) << "errESi\n";
 ...
 //----- Loading cut ranges to take DEE points ------------------
  while (FileInCut.is_open() && !FileInCut.eof())
  {
    ...
    for(int XChannel=CutStart; XChannel<CutEnd; XChannel+=CutStep)
    {
      ...
      double errESi = errPercentageSiE *ESi;
      if(ESi<=0) continue;
      ...
      FileOut << setw(5) << numtel << setw(10) << numcsi << setw(5) << Z << setw(5) << A << setw(15) << XChannel << setw(15) << 0.5  << setw(15) << CsIE << setw(15) << errCsIE  <<endl;
      FileOutDEE << setw(5) << numtel << setw(10) << numcsi << setw(5) << Z << setw(5) << A << setw(15) << XChannel << setw(15) << 0.5 << setw(15) << ESi << setw(15) << errESi  <<endl;
