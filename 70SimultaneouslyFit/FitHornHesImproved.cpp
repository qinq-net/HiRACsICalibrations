  ...
  for(int FileNum=0; FileNum<NFiles_He3; FileNum++)
  {
    ...
    for(int i=0; i<12; i++)
    {
      for(int j=0; j<4; j++)
      {
        ...
        DataHe3[i][j][FileNum]->SetMarkerSize(1.5);
      }
    }
    FileIn_He3.close();
  }
  ...
  for(int FileNum=0; FileNum<NFiles_He4; FileNum++)
  {
    ...
    for(int i=0; i<12; i++)
    {
      for(int j=0; j<4; j++)
      {
        ...
        DataHe4[i][j][FileNum]->SetMarkerSize(1.5);
      }
    }
    FileIn_He4.close();
  }
  ...
  for(int FileNum=0; FileNum<NFiles_He6; FileNum++)
  {
    ...
    for(int i=0; i<12; i++)
    {
      for(int j=0; j<4; j++)
      {
        ...
        DataHe6[i][j][FileNum]->SetMarkerSize(1.5);
      }
    }
    FileIn_He6.close();
  }
...
//______________________________________________________________________________
  ...
  TF2 *fHeavyIonImproved= new TF2("fHeavyIonImproved",HornFitImproved,0,500,200,500,5);
  fHeavyIonImproved->SetParameters(0.0,0.01,20.0,15.0,1.0);
