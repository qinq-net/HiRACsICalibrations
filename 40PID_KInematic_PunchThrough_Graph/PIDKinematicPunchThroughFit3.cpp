...
void PIDKinematicPunchThroughFit3()
{
  
//  std::string FileOutTag("deuterons");
  std::string FileOutTag("tritons");
...
*/
  ...
  //--- files for tritons
  FileIn_name[0] = new std::string(Form("datfile/HiRA_CsI_DEELowEnergy_Z%02d_A%02d.dat", 1, 3));
  FileIn_name[1] = new std::string(Form("datfile/HiRA_CsI_DEEMidEnergy_Z%02d_A%02d.dat", 1, 3));
  FileIn_name[2] = new std::string(Form("datfile/HiRA_CsI_PunchThrough_Z%02d_A%02d.dat", 1, 3));
