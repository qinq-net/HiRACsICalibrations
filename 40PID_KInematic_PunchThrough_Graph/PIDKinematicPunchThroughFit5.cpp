...
void PIDKinematicPunchThroughFit5()
{
  

  std::string FileOutTag("4He");
  ...
  //--- files for tritons
  FileIn_name[0] = new std::string(Form("datfile/HiRA_CsI_DEELowEnergy_Z%02d_A%02d.dat", 2, 4));
  FileIn_name[1] = new std::string(Form("datfile/HiRA_CsI_DEEMidEnergy_Z%02d_A%02d.dat", 2, 4));
